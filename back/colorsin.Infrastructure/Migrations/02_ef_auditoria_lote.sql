...
ALTER TABLE `movimientos_inventario` ADD `lote_id` int NULL;

ALTER TABLE `movimientos_inventario` ADD `observaciones` varchar(255) COLLATE utf8mb4_0900_ai_ci NULL;

CREATE TABLE `auditoria_eventos` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `modulo` varchar(50) COLLATE utf8mb4_0900_ai_ci NOT NULL,
    `accion` varchar(80) COLLATE utf8mb4_0900_ai_ci NOT NULL,
    `usuario_id` int NOT NULL,
    `detalle` varchar(1000) COLLATE utf8mb4_0900_ai_ci NULL,
...
CREATE INDEX `idx_movinv_lote` ON `movimientos_inventario` (`lote_id`);

CREATE INDEX `idx_auditoria_modulo_fecha` ON `auditoria_eventos` (`modulo`, `fecha`);

CREATE INDEX `idx_auditoria_usuario` ON `auditoria_eventos` (`usuario_id`);

ALTER TABLE `movimientos_inventario` ADD CONSTRAINT `fk_movinv_lote` FOREIGN KEY (`lote_id`) REFERENCES `lotes` (`id`) ON DELETE RESTRICT;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260917144414_AuditoriaYTrazabilidadLote', '9.0.20');
