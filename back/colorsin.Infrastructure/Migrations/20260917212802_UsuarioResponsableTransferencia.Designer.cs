...
namespace colorsin.Infrastructure.Migrations
{
    ...
    [Migration("20260917212802_UsuarioResponsableTransferencia")]
    partial class UsuarioResponsableTransferencia
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Colorsin.Domain.Compras.OrdenCompra", b =>
                {
                    ...
                    b.Property<string>("Estado")
                        .HasColumnType("enum('Pendiente','Confirmada','ParcialmenteRecibida','Recibida','Cancelada')")
                    ...
                    b.HasIndex("ProveedorId")
                        .HasDatabaseName("idx_oc_proveedor");
            ...
            modelBuilder.Entity("Colorsin.Domain.Compras.OrdenCompraDetalle", b =>
                {
                    ...
                    b.HasIndex("OrdenCompraId")
                        .HasDatabaseName("idx_ocd_orden");

                    b.HasIndex("ProductoId")
                        .HasDatabaseName("idx_ocd_producto");

                    b.HasIndex("UnidadId")
                        .HasDatabaseName("idx_ocd_unidad");
            ...
            modelBuilder.Entity("Colorsin.Domain.Compras.ProductoProveedor", b =>
                {
                    ...
                    b.HasIndex("ProveedorId")
                        .HasDatabaseName("idx_prodprov_proveedor");
            ...
            modelBuilder.Entity("Colorsin.Domain.Comun.Usuario", b =>
                {
                    ...
                    b.HasIndex("SucursalId")
                        .HasDatabaseName("idx_usuarios_sucursal");
            ...
            modelBuilder.Entity("Colorsin.Domain.Inventario.InventarioSucursal", b =>
                {
                    ...
                    b.HasIndex("ProductoId")
                        .HasDatabaseName("idx_inventario_producto");
            ...
            modelBuilder.Entity("Colorsin.Domain.Inventario.Lote", b =>
                {
                    ...
                    b.HasIndex("SucursalId")
                        .HasDatabaseName("idx_lotes_sucursal");
            ...
            modelBuilder.Entity("Colorsin.Domain.Inventario.MovimientoInventario", b =>
                {
                    ...
                    b.HasIndex("Fecha")
                        .HasDatabaseName("idx_movinv_fecha");

                    b.HasIndex("LoteId")
                        .HasDatabaseName("idx_movinv_lote");

                    b.HasIndex("Motivo")
                        .HasDatabaseName("idx_movinv_motivo");

                    b.HasIndex("ProductoId")
                        .HasDatabaseName("idx_movinv_producto");

                    b.HasIndex("TransferenciaId")
                        .HasDatabaseName("idx_movinv_transferencia");

                    b.HasIndex("UnidadId")
                        .HasDatabaseName("idx_movinv_unidad");

                    b.HasIndex("UsuarioId")
                        .HasDatabaseName("idx_movinv_usuario");
            ...
            modelBuilder.Entity("Colorsin.Domain.Inventario.Producto", b =>
                {
                    ...
                    b.HasIndex("UnidadBaseId")
                        .HasDatabaseName("idx_productos_unidad_base");
            ...
            modelBuilder.Entity("Colorsin.Domain.Transferencias.NovedadTransferencia", b =>
                {
                    ...
                    b.HasIndex("Tipo")
                        .HasDatabaseName("idx_novtransf_tipo");

                    b.HasIndex("TransferenciaId")
                        .HasDatabaseName("idx_novtransf_transferencia");

                    b.HasIndex("UsuarioId")
                        .HasDatabaseName("idx_novtransf_usuario");
            ...
            modelBuilder.Entity("Colorsin.Domain.Transferencias.Transferencia", b =>
                {
                    ...
                    b.Property<string>("Estado")
                        .HasColumnType("enum('Solicitada','EnTransito','Completada','RecibidaParcial','Rechazada','Cancelada')")
                        .HasColumnName("estado");
                    ...
                    b.HasIndex("Estado")
                        .HasDatabaseName("idx_transf_estado");

                    b.HasIndex("ProductoId")
                        .HasDatabaseName("idx_transf_producto");

                    b.HasIndex("SucursalOrigenId")
                        .HasDatabaseName("idx_transf_origen");

                    b.HasIndex("TransportadoraId")
                        .HasDatabaseName("idx_transf_transportadora");
            ...
            modelBuilder.Entity("Colorsin.Domain.Ventas.Venta", b =>
                {
                    ...
                    b.HasIndex("ClienteId")
                        .HasDatabaseName("idx_ventas_cliente");

                    b.HasIndex("Fecha")
                        .HasDatabaseName("idx_ventas_fecha");

                    b.HasIndex("UsuarioId")
                        .HasDatabaseName("idx_ventas_usuario");
            ...
            modelBuilder.Entity("Colorsin.Domain.Ventas.VentaDetalle", b =>
                {
                    ...
                    b.HasIndex("ProductoId")
                        .HasDatabaseName("idx_vd_producto");

                    b.HasIndex("UnidadId")
                        .HasDatabaseName("idx_vd_unidad");

                    b.HasIndex("VentaId")
                        .HasDatabaseName("idx_vd_venta");
